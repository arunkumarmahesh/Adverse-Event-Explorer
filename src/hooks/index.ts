export { useDetailDatas } from "./useDetailDatas/useDetailDatas";
export {
  useDetailDatasCurrent
} from "./useDetailDatasCurrent/useDetailDatasCurrent";
export {
...
// export { useGroupsSub } from "./XXuseGroupsSub/useGroupsSub";
